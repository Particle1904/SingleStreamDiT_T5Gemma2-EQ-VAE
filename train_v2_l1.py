...
RESUME_FROM = "./checkpoints/checkpoint2_epoch_600.pt"  # Set to "checkpoints/v3/epoch_50.pt" to resume. Set to None for fresh start.
START_EPOCH = 601     # If resuming, set this manually (e.g. 50). If None, 0.
